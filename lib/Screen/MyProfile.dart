  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        _getDrawerItem(getTranslated(context, 'ACCOUNT_TAB')!,
            'assets/images/pro_aboutus.svg'),
        //CUR_USERID == "" || CUR_USERID == null ? Container() : _getDivider(),
        // CUR_USERID == "" || CUR_USERID == null ? Container() : _getDrawerItem(getTranslated(context, 'MYWALLET')!,
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          } else if (title == getTranslated(context, 'ACCOUNT_TAB')) {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => AccountTab(
                    title: getTranslated(context, 'ACCOUNT_TAB'),
                  ),
                ));}
